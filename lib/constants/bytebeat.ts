...
export const BYTEBEAT_SONGS: BytebeatSong[] = [
  ...
  },
  {
    ...
    source:
      'z=40.7,b=t/2250,r=int(b),y=r%16,a=[1,2,1,2,1.2,2.4,1.2,2.4,1.33,2.67,1.33,2.67,1.5,3,1.5,3][y],o=(c=1<r%64&&33>r%64)?1.19:1.5,n=[0,0,2.38,2.67,2.38,0,2,2.24,0,2.38,0,2.24,0,1.78,0,2,2,2,1,1.19,1.5,0,1.19,1.33,0,1.19,0,c?1.12:1.33,0,o,o,o],x=int(r/4)%4,d=[12,12,10.67,12][x],g=[9.52,9.52,8,8.96][x],h=[8,7.12,6.72,7.52][x],v=2*b%4*1.25,w=int(y/12),u=int(r/16)%4,j=[[19.04,17.92],[14.24,9.52],[10.64,12],[8,0]],sin(1/z*t+7*sin(1.125*t/z)*(0<1-2*b%4?1-2*b%4:0))*(40-15*b%30)+40+(16>b?0:random()*(2==r%4?32-32*b%32:0))+(32>b?0:random()*(16-(16>28*b%28?28*b%28:16)))+(64>b?0:32*sin(a/z*t+4*sin(t*a/z)*(1-b%1))+32)+(96>b?0:sin(t*d/z+sin(t*d/z)*(1.5*b%3))*v+5)+(96>b?0:sin(t*g/z+sin(t*g/z)*(1.5*b%3))*v+5)+(96>b?0:sin(t*h/z+sin(t*h/z)*(1.5*b%3))*v+5)+(128>b?0:t*n[r%32]*8%256>121+abs(108-56*b%224)?20:0)+(129>b?0:t*n[(r-1)%32]*7.98%256>121+abs(108-56*b%224)?7:0)+(192>b?0:sin(j[u][w]/z*t+4*sin(2*t*j[u][w]/z)*(2>y||12<=y&14>y?1-b/2%1:0))*(5.3-y/3%4)+5.3)',
    sampleRate: 11025,
