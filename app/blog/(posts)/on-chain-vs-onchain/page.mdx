...
Personally, most of my work falls under the "on-chain" descriptor, so I usually still use that term, but I've started using "onchain" in more casual settings (e.g. DMs).
In my opinion, the 2 terms have now diverged enough and each found enough meaning that they will continue to coexist in their current forms.
