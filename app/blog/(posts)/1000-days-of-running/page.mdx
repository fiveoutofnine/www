...
export const metadata = getBlogPageMetadata({
  ...
  description: 'Overview and reflections on running everyday for 1,000 days.',
});

<BlogHeader slug="1000-days-of-running" />

As of <RelativeDate date={new Date("2025-05-27T03:03:10.000Z")} type="absolute" />, I&apos;ve ran every day for the last 1,000 days.
...
<Callout intent="info">
  ...
  Or maybe I just psyoped myself into running <Distance className="text-blue-11 hover:text-blue-12" m={18_779_010} />.
</Callout>
...
For example, if I wanted to run for 91:40, I&apos;d count to 5,500 seconds as the sum of 1,000, 900, ..., 100 seconds: 16:40 -> 31:40 (+15:00) -> ... -> 91:40 (+1:40).
...
The long-term goal is still to get good at running the half marathon/marathon distances&mdash;it would be really cool to qualify for the US Olympic Trials (requires a ~<Pace s={193} /> marathon as of 2025).
...
- The largest personal growth from running has been it serving as a really strong example of "you can just do things" because I went into the 1,000 days with the plan "run <Distance m={128_748} />/week to <Distance m={160_934} />/week for like 10 years, and you can&apos;t be bad," and it seems to be true.
