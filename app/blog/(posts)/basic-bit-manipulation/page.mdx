...
<Table.Root className="my-0" containerClassName="-mx-4 w-screen sm:mx-0 sm:w-full">
  <Table.Header>
    <Table.Row>
...
* Books
    * Hacker's Delight 2nd Edition
        ...
        * [IPFS URI](https://ipfs.io/ipfs/bafykbzacedcjrpilvhgfkt5ampruid6qpwdcvjh2gpo44z6dqg5oq7hryysk4)
