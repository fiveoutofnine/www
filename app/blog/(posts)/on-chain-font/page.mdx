import { WriteGlyphsAccordion } from './client-components';
...
<DesignComponentsDisplay source={SVG_USAGE_SOURCE} sourceInitiallyDisplayed>
  bruh
</DesignComponentsDisplay>

export const SVG_USAGE_SOURCE = `<svg {...} >
    <style type="text/css">
        @font-face {
