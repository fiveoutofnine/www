...
For example, if there's a 3×4 block of the same color, it'd be better to render a single 3×4 rectangle, as opposed to 12 1×1 squares (as you might with generalized pixel art markup).
...
<Callout>
  ...
  Note: I eyeballed the whole process until it felt optimized enough, as opposed to finding some optimal algorithm.
