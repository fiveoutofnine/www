  ...
  return (
    <Radio.Group className="flex flex-col gap-4">
      <div className="flex items-center gap-1.5">
        <Radio.Item
          id="radio_type_normal"
          value="1"
          type="normal"
          aria-labelledby="radio_type_normal_label"
        />
        <label
          id="radio_type_normal_label"
          htmlFor="radio_type_normal"
    ...
    <Radio.Group>
      <div className="flex items-center gap-1.5">
        <Radio.Item
          ...
          value="1"
          type="normal"
          aria-labelledby="radio_normal_1_label"
        />
        <label
          id="radio_normal_1_label"
          htmlFor="radio_normal_1"
          className="text-sm font-medium text-gray-12"
        >
          Option 1
        </label>
      ...
      <div className="flex items-center gap-1.5">
        <Radio.Item
          ...
          value="2"
          type="normal"
          aria-labelledby="radio_normal_2_label"
        />
        <label
          id="radio_normal_2_label"
          htmlFor="radio_normal_2"
          className="text-sm font-medium text-gray-12"
        >
          Option 2
        </label>
      ...
      <div className="flex items-center gap-1.5">
        <Radio.Item
          ...
          value="3"
          type="normal"
          aria-labelledby="radio_normal_3_label"
          disabled
        />
        <label
          id="radio_normal_3_label"
          htmlFor="radio_normal_3"
          className="text-sm font-medium text-gray-12"
        >
          Option 3
        </label>
